    ...
    <div className="bg-input/50 inline-flex h-8 rounded-full p-0.5">
      ...
      >
        <label className="group-data-[state=marketing]:text-muted-foreground/70 relative z-10 inline-flex h-full min-w-8 cursor-pointer items-center justify-center px-4 whitespace-nowrap transition-colors select-none gap-2">
          <Icon name="coding" className="w-3 h-3 text-black" />
          <span className="text-xs">Dev</span>
          <RadioGroupItem id={`${id}-1`} value="dev" className="sr-only" />
        </label>
        <label className="group-data-[state=dev]:text-muted-foreground/70 relative z-10 inline-flex h-full min-w-8 cursor-pointer items-center justify-center px-6 whitespace-nowrap transition-colors select-none gap-2 text-blue-500">
